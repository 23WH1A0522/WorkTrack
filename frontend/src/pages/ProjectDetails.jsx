...
import { ArrowLeftIcon, PlusIcon, BarChart3Icon, CalendarIcon, FileStackIcon, ZapIcon } from "lucide-react";
    ...
    <div className="space-y-5 max-w-6xl mx-auto text-zinc-900 dark:text-white">
      ...
      <div className="grid grid-cols-2 sm:flex flex-wrap gap-6">
        {[
          ...
          { label: "Completed", value: tasks.filter((task) => task.status === "DONE").length, color: "text-emerald-700 dark:text-emerald-400" },
          { label: "In Progress", value: tasks.filter((task) => task.status === "IN_PROGRESS" || task.status === "TODO").length, color: "text-amber-700 dark:text-amber-400" },
